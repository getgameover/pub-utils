...
public class Amount2RMB {
     ...
     */
    public static String convert(BigDecimal price) throws IllegalArgumentException {
        String amount = price.setScale(2, RoundingMode.DOWN).toString();
